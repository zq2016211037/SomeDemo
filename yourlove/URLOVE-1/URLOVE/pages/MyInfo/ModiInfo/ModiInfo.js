...
Page({
  			...
  			success: function (res) {
    			...
    			wx.uploadFile({
    				...
    				success: function(res){
    					...
    					wx.request({
    						url: "http://120.78.165.40:9090/user/setUserAvatarUrl",
    						data:{
								userId: userId,
								avatarName: filename
							},
	...
	bindDateChange: function (e) {
	    ...
	    var that = this;
		wx.request({
			url: "http://120.78.165.40:9090/user/setUserBirthday",
			method: "POST",
			data:{
		    	userId:userId,
	...
	submitname: function(options){
		var that = this;
		wx.request({
			url: "http://120.78.165.40:9090/user/setUserNickName",
			method: "POST",
			data:{
		    	userId:userId,
	...
	submitsignature: function(options){
		var that = this;
		wx.request({
			url: "http://120.78.165.40:9090/user/setUserSignature",
			method: "POST",
			data:{
		    	userId:userId,
	...
	submitemail: function(options){
		var that = this;
		wx.request({
			url: "http://120.78.165.40:9090/user/setUserMail",
			method: "POST",
			data:{
		    	userId:userId,
